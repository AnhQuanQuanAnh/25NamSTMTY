...
module.exports = {
  ...
  "cd.menu.news": "Tin tức",
  "cd.menu.logo": "Ý nghĩa Logo",
  "cd.menu.department": "Các tiểu ban",
  "cd.menu.dp_external": "Tiểu ban đối ngoại",
  "cd.menu.dp_finance": "Tiểu ban tài chính",
  "cd.menu.dp_art": "Tiểu ban văn nghệ",
  "cd.menu.dp_communication": "Tiểu ban truyền thông",
  "cd.menu.dp_ritual": "Tiểu ban lễ nghi",
  "cd.menu.yearbook": "Kỷ yếu",
  "cd.menu.yb_cd": "Kỷ yếu Cộng Đoàn",
  "cd.menu.yb_ducdiem": "Nhóm Đức-Diễm",
  "cd.menu.yb_quanuyen": "Nhóm Quân-Uyên",
  "cd.menu.yb_trungphuc": "Nhóm Trung-Phúc",
  "cd.menu.yb_khoaphuong": "Nhóm Khoa-Phương",
  "cd.menu.yb_hungquynh": "Nhóm Hưng-Quỳnh",
  "cd.menu.media": "Tư liệu phim ảnh",
  "cd.menu.hautruong": "Hậu trường",

  "cd.email.placeholder": "Địa chỉ E-mail",
  "cd.button.regist": "Đăng kí",
  ...
  "cd.footer.menu-1-2-1": "CỘNG ĐOÀN GIA ĐÌNH SỐNG TIN MỪNG TÌNH YÊU",
  "cd.footer.menu-1-3": "Email:",
  "cd.footer.menu-1-3-1": "admin@songtinmungtinhyeu.org",
  "cd.footer.menu-1-4": "Điện thoại:",
  "cd.footer.menu-1-4-1": "0983876365",
  "cd.footer.menu-2": "Thư thông báo",
  "cd.footer.menu-2-1": "Hãy nhập Email của bạn vào khung dưới và nhấn Đăng ký để nhận thông tin mới nhất từ chúng tôi.",
  "lp.footer.menu-2-2": "Pricing",
  "cd.footer.copyright": "BẢN QUYỀN CỦA CỘNG ĐOÀN GIA ĐÌNH SỐNG TIN MỪNG TÌNH YÊU © 2019",

  "cd.news.title": "Tin Tức",
  ...
  "cd.news.title-1": "Progressively Maintain Extensive Infomediaries",
  ...
  "cd.news.title-2": "Assertively Iterate Resource Maximizing",
  ...
  "cd.news.title-3": "Podcasting Operational Change Management Inside of Workflows",
  ...
  "cd.news.title-4": "Objectively Innovate Empowered Manufactured Products",
  ...
  "cd.news.title-5": "Assertively Iterate Resource Maximizing",
  ...
  "lp.meaning-logo.title": "GIỚI THIỆU LOGO CỘNG ĐOÀN",
